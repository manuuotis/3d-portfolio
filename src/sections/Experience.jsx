...
import { FaCode, FaBug, FaDesktop, FaMobile } from "react-icons/fa";
...
const Experience = () => {
  const getIcon = (iconName) => {
    ...
    return IconComponent ? <IconComponent className="text-turquoise-50 text-2xl" /> : null;
  };
